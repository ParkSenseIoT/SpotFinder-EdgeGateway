...
- **Not implemented yet (next steps)**
  - forwarding consolidated events to the SpotFinder cloud backend
    (`POST /api/v1/sensor-readings`, `/api/v1/emergency/alerts`)
...
- **Embedded app** (ESP32 firmware): SpotFinder-EmbeddedApp *(to be created)*.
